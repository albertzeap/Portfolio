  ...
  *********************************************************************************************************************************/
  void carefully_move_grocery_items( std::size_t quantity, std::stack<GroceryItem> & sourceCart, std::stack<GroceryItem> & destinationCart, std::stack<GroceryItem> & spareCart )
  {
    ///////////////////////// TO-DO //////////////////////////////
      ...
      if (quantity == 1) 
      {
        sourceCart.swap(destinationCart);
        return;
      }

      else
      {
        carefully_move_grocery_items ( quantity - 1, sourceCart, destinationCart, spareCart );
...
int main()
{
  ...
  ///////////////////////// TO-DO //////////////////////////////
    ...
    ///      00075457129000   milk             any                     <===  heaviest item, put this on the bottom
     ...
     GroceryItem milk         = { "00075457129000" , "milk"                                  }; //Any brand
     GroceryItem riceKrispies = { "00038000291210" , "rice krispies " , "Kellogg's"          };
     GroceryItem hotdogs      = { "00025317533003" , "hotdogs"        , "Applegate Farms"    };
     GroceryItem applePie     = { "09073649000493" , "apple pie"                             }; //Any brand
     GroceryItem bread        = { "00835841005255" , "bread"                                 }; //Any brand
     GroceryItem eggs         = { "00688267039317" , "eggs"                                  }; //Any brand


     myCart.push ( milk         );
     myCart.push ( riceKrispies );
     myCart.push ( hotdogs      );
  ...
  ///////////////////////// TO-DO //////////////////////////////
   ...
   { 
     GroceryItem temp =  checkoutCounter.front();
     storeDataBase.find(temp.upc());
     amountDue += temp.price();
     std::cout << temp;
     checkoutCounter.pop(); 
